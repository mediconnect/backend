...
class SearchTestCase(TestCase):
    ...
    def setUp(self):
        ...
        Info.objects.create(disease=disease, hospital=hospital)
    ...
    def test_normal_search(self):
        ...
        for disease_entry in disease_data:
            ...
            for i, hospital_entry in enumerate(hospital_data):
                ...
                Info.objects.create(rank=i, disease=disease, hospital=hospital)
        ...
        for i in data['infos']:
            self.assertIsNotNone(Info.objects.filter(id=i).first())
